...
class CourseRewardServiceTest {
    ...
    @Mock
    private CourseRewardRepository courseRewardRepository;

    @Mock
    private CourseRewardFailureRepository courseRewardFailureRepository;

    @Mock
    private LmsCoursePort lmsCoursePort;

    @Mock
    private CourseRewardUseCase self;

    @InjectMocks
    private CourseRewardService courseRewardService;
    ...
    void recordsRewardFailureAsPending() {
        ...
        courseRewardService.recordFailure(
    ...
    void retriesPendingFailureAndMarksResolvedWhenRewardSucceeds() {
        ...
        var result = courseRewardService.retryFailure(
        ...
        verify(self).rewardCourseWithDetails(any());
    }
    ...
    void retriesPendingFailureAndMarksFailedWhenRewardFails() {
        ...
        RuntimeException exception = assertThrows(
                ...
                () -> courseRewardService.retryFailure(
                        new RetryCourseRewardFailureCommand(FAILURE_ID)
                )
        );
    ...
    void getsFailuresByStatus() {
        ...
        var results = courseRewardService.getFailures(CourseRewardFailureStatus.PENDING);
    ...
    void getsRetryableFailures() {
        ...
        var results = courseRewardService.getRetryableFailures(3);
