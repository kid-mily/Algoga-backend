...
public class ChatLog {
    private final Long chatLogId; private final Long userId; private final String question;
    private final String answer; private final boolean isFiltered; private final Instant createdAt;
    @Builder private ChatLog(Long chatLogId, Long userId, String question, String answer, boolean isFiltered, Instant createdAt) {
        this.chatLogId = chatLogId; this.userId = userId; this.question = question;
        this.answer = answer; this.isFiltered = isFiltered; this.createdAt = createdAt;
    }
