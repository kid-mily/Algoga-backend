package com.kidmily.algoga_server.booking.presentation.advice;
...
@Slf4j
@RestControllerAdvice(basePackages = "com.kidmily.algoga_server.booking.presentation.api")
public class BookingExceptionAdvice implements CommonExceptionAdvice {
