...
import com.kidmily.algoga_server.qna.presentation.response.AdminCourseQnaDetailResponse;
import com.kidmily.algoga_server.qna.presentation.response.AdminCourseQnaResponse;
...
public class AdminCourseQnaController {
    ...
    @ApiErrorCodeExample(domain = QnaErrorCode.class, value = {
            "COURSE_NOT_FOUND",
            "QNA_NOT_FOUND"
    })
    @PreAuthorize("hasAnyAuthority('CONTENT_MANAGER', 'ROLE_CONTENT_MANAGER', 'SUPER_ADMIN', 'ROLE_SUPER_ADMIN')")
    ...
    public ResponseEntity<ApiResponse<AdminCourseQnaResponse>> answerQna(
        ...
        var qna = courseQnaUseCase.answerQna(command);
