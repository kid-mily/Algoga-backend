package com.kidmily.algoga_server.completion.presentation.support;

import com.kidmily.algoga_server.completion.exception.CompletionErrorCode;
import com.kidmily.algoga_server.completion.exception.CompletionException;
...
public final class CurrentUserIdResolver {
    ...
    public static Long resolveLoginRequired(Object principal) {
        ...
        if (userId == null) {
            throw new CompletionException(CompletionErrorCode.LOGIN_REQUIRED);
        }
        return userId;
    }
