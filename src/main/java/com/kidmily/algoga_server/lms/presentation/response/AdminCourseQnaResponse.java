...
@Schema(description = "관리자 강의 Q&A 응답")
public record AdminCourseQnaResponse(
    ...
    public static AdminCourseQnaResponse from(CourseQnaResult qna) {
        return new AdminCourseQnaResponse(
                qna.qnaId(),
                qna.courseId(),
                qna.userId(),
                qna.username(),
