...
import com.kidmily.algoga_server.lms.presentation.request.admin.CreateDiagnosisQuestionRequest;
import com.kidmily.algoga_server.lms.presentation.request.admin.UpdateDiagnosisQuestionRequest;
import com.kidmily.algoga_server.lms.presentation.response.AdminDiagnosisQuestionResponse;
import com.kidmily.algoga_server.lms.presentation.response.AdminDiagnosisResultResponse;
...
public class AdminDiagnosisController {
    ...
    @PreAuthorize("hasAnyAuthority('CONTENT_MANAGER', 'ROLE_CONTENT_MANAGER', 'SUPER_ADMIN', 'ROLE_SUPER_ADMIN')")
    @GetMapping("/results")
    public ResponseEntity<ApiResponse<List<AdminDiagnosisResultResponse>>> getResults(
            @RequestParam(required = false) Long userId,
            @RequestParam(required = false) Long countryId
    ) {
        List<AdminDiagnosisResultResponse> response = diagnosisUseCase.getAdminResults(userId, countryId)
                .stream()
