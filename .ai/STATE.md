...
- Current uncommitted slice: Course file/storage package split.
...
1. Review and commit the Course file/storage package split slice.
2. Continue LMS package split with one of these small slices:
   - Remaining course command/usecase/port files.
   - CourseService orchestration extraction.
   - LMS exception package decision after remaining services are moved.
